...
def add_view(request):
    ...
    resp = render(request,'FUN/add.html')
    return resp
...
def show_view(request):
    ...
    d={'emp':emp}
    resp = render(request,'FUN/showall.html',context=d)
    return resp
...
def view_employee(request,eid):
    ...
    d={'emp':emp}
    resp = render(request,'FUN/view.html',context=d)
    return resp
...
def update_view(request,eid):
    ...
    if request.method=="POST":
        ...
        return redirect('/')
    d={'data':data}
    resp = render(request,'FUN/update.html',context=d)
    return resp
